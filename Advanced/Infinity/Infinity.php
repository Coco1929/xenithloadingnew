...
/**
 * @package Advanced\Infinity
 */
class Infinity implements AdvancedThemeInterface
{
    /**
     * @var Templater
     */
     ...
     * @var string
     */
    private $tplPath = BASE_PATH . 'Advanced/Infinity/templates/';
    ...
    {
        $settings = $this->parseJson('/Advanced/Infinity/settings.json');
    ...
    {
        $this->updateJson('/Advanced/Infinity/settings.json', [
            "header" => $_POST['header']
        ]);
