...
/**
 * @package Advanced\Millenium
 */
class Millenium implements AdvancedThemeInterface
{
    /**
     * @var Templater
     */
     ...
     * @var string
     */
    private $tplPath = BASE_PATH . 'Advanced/Millenium/templates/';
    ...
    {
        $settings = $this->parseJson('/Advanced/Millenium/settings.json');
    ...
    {
        $this->updateJson('/Advanced/Millenium/settings.json', [
            "header" => $_POST['header']
        ]);
