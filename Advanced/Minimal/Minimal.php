...
/**
 * @package Advanced\Minimal
 */
class Minimal implements AdvancedThemeInterface
{
    /**
     * @var Templater
     */
     ...
     * @var string
     */
    private $tplPath = BASE_PATH . 'Advanced/Minimal/templates/';
    ...
    {
        $settings = $this->parseJson('/Advanced/Minimal/settings.json');
    ...
    {
        $this->updateJson('/Advanced/Minimal/settings.json', [
            "header" => $_POST['header']
        ]);
