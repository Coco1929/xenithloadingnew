...
<div class="wrapper">
    <div class="container">
        ...
        <div class="row w-75">
            ...
            <!--@Main row-->
            <div class="col-md-4 col-lg-4 col-sm-4 col-4" style="width:33%; display:inline-block;">
            ...
            <div class="col-md-4 col-lg-4 col-sm-4 col-4" style="width:33%; display:inline-block;">
                <div >
                <img id="mapimg" class="centering" src="/pub/minimal/unknownmap.png" onerror="this.src='/pub/minimal/unknownmap.png'"/></div>
            </div>
        </div>
