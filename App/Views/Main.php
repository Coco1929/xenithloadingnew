 ...
 * @package App\Views
 */
class Main extends Templater
{
    /**
     * @param string $themeData
     */
    public function renderMainPage($themeData, $advanced)
    {
        $themeData['advanced'] = $advanced;
        $themeData['style'] = $this->abs_render($_SERVER['DOCUMENT_ROOT'] . '/styles/'.$themeData['style']['name'].'/'.strtolower($themeData['style']['name']), $themeData);

        echo $this->render('main', $themeData);
    }
}